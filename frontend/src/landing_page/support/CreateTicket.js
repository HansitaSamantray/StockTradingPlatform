  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-6 mt-5 mb-2">
          <h4 className="fs-2">
         ...
         <div className="col-4 p-6 mt-5 mb-2">
          <h4 className="fs-2">
            <i class="fa fa-user fa-sm" aria-hidden="true"></i> Your Zerodha Account
          </h4>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Login Credentials</a> <br />
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Account Modification and Segmentation Addition</a> <br />
         ...
         <div className="col-4 p-6 mt-5 mb-2">
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Find Withdrawal</a> <br />
